package com.home.OOP.catmouse;

public class Cat {
    // Кот: имя, цвет, скорость, вес, пойманные мыши;

    private final String name = Random.nameGen();
    private final String color = Random.colorGen();
    private final int speed = Random.speedGen();
    private final int weight = Random.wightGen();
    private Mouse[] catches = new Mouse[Settings.MAX_CATCHES];
