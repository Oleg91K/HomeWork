...
public class PupilTask {
    ...
    public static void main(String[] args) {
        ...
        //Map<Pupil.Gender, ArrayList<Pupil>>Pupil::getGender вызываает метод получает пол.дальше создает ключ
        //Pupil.Gender.MALE : ArrayList<Pupil>:"Женя","Олег" - значение
        ...
        pupils.sort(Comparator.comparing(Pupil::getGender)
        ...
        Map<Pupil.Gender,Integer> genderAge = pupils.stream()
                .collect(Collectors.groupingBy(Pupil::getGender,Collectors.summingInt(
